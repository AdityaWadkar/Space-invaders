...
overimg = pygame.image.load("background1.jpg")
...
class Ship:
    ...
    def shoot(self):
        ...
        if self.cool_down_counter == 0:
            laser = Laser(self.x+22, self.y-15, self.laser_img)
...
def button(msg, x, y, w, h, ic, ac, action=None):
    ...
    textSurf, textRect = text_objects(msg, smallText, color=red)
...
def paused():
    ...
    while pause:
        ...
        button("Continue", 130, 380, 120, 35, green, light_green, unpause)
        button("Quit", screen_width - 200, 380, 100, 35, purple, voilet, quit_game)
...
def mainloop():
    ...
    while not exit_game:
        ...
        if rel_bgh < screen_height:
            ...
            # gamewindow.blit(bullet, (ship_x + 25, ship_y - 35))
        ...
        if lives <= 0 or player.health <= 0:
            ...
            # col = collide(bulletx, bullety, enemy1)
            # if col == True:
            #     bullety = player.y
            #     state = "ready"
            #     score += 1
